...
{     
    ...
    public class JobController : ControllerBase
    {
        ...
        //POST: api/jobs
        [HttpPost]
            public async Task<ActionResult> PostJobAsync([FromBody] Job evnt)
            {
                try
                {
                if (evnt == null)
                ...
                var created_id = await _ADOuow._JobRepository.AddAsync(evnt);
                    _ADOuow.Commit();
        ...
        //POST: api/jobs/id
        [HttpPut("{id}")]
            public async Task<ActionResult> UpdateEventAsync(int id, [FromBody] Job evnt)
            {
                try
                {
                    if (evnt == null)
                    ...
                    await _ADOuow._JobRepository.ReplaceAsync(evnt);
                    _ADOuow.Commit();
